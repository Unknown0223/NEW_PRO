...
Xatolik javoblari yagona shape’da qaytadi:
- `error`: mashinada o‘qiladigan xato kodi
- `message`: foydalanuvchi uchun qisqa izoh (ixtiyoriy)
- `requestId`: har bir so‘rov/javob uchun korrelatsiya ID
- `details`: validatsiya xatolari bo‘lsa (ixtiyoriy)
