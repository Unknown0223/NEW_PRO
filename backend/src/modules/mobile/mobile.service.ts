...
/** Mobil ilova: agent | expeditor | supervisor — `mobile_config` + `agent_entitlements` (o‘qish). */
export async function getMobileAgentConfigPayload(tenantId: number, userId: number) {
