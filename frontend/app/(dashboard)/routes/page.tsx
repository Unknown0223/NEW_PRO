  ...
  const saveMut = useMutation({
    ...
    onError: (e: unknown) => {
      if (e instanceof Error && e.message === "json") {
        setSaveErr("JSON noto‘g‘ri: sintaksis yoki qatorlarni tekshiring.");
        return;
      }
      if (axios.isAxiosError(e)) {
        ...
        if (hint) {
          setSaveErr(withApiSupportLine(hint, e));
          return;
        }
      }
      setSaveErr(getUserFacingError(e, "Marshrutni saqlab bo‘lmadi."));
    }
  });
