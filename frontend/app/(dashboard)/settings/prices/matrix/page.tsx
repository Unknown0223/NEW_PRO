        ...
        <div className="mb-4 flex flex-wrap items-end gap-3">
          ...
          <div className="grid gap-1">
            ...
            {pickZodLeaf(serverFieldErrs, "price_type") ? (
              <p className="text-xs text-destructive">{pickZodLeaf(serverFieldErrs, "price_type")}</p>
            ) : null}
          </div>
          <div className="grid gap-1">
            ...
            {pickZodLeaf(serverFieldErrs, "category_id") ? (
              <p className="text-xs text-destructive">{pickZodLeaf(serverFieldErrs, "category_id")}</p>
            ) : null}
          </div>
        </div>
