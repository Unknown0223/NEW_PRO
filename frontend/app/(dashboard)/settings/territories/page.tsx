          ...
          {activeTab === "tree" ? (
            ...
            <div className="grid gap-4">
              <div className="rounded-lg border p-3">
                ...
                {pickZodLeaf(serverFieldErrs, "territory_levels") ? (
                  <p className="mt-2 text-xs text-destructive">{pickZodLeaf(serverFieldErrs, "territory_levels")}</p>
                ) : null}
                {pickZodLeaf(serverFieldErrs, "territory_nodes") ? (
                  <p className="mt-1 text-xs text-destructive">{pickZodLeaf(serverFieldErrs, "territory_nodes")}</p>
                ) : null}
              </div>
