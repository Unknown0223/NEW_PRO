...
function applyDifferenceToCells(
  ...
  return cells.map((cell) => {
    ...
    if (aggregationForColumn(cell.columnKey, config) !== "DIFFERENCE") return cell;
...
export function applyDifferenceAggregations(data: PivotData, config: PivotConfig): PivotData {
