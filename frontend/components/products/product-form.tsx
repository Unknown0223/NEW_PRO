    ...
    >
      ...
      <div className="grid gap-3">
        ...
        <div className="grid gap-1.5">
          ...
          <FieldHint name="category_id" errors={fieldErrors} />
        </div>
        <div className="grid gap-1.5">
        ...
        <div className="grid gap-1.5">
          ...
          <Input
            ...
            autoComplete="off"
          />
          <FieldHint name="sku" errors={fieldErrors} />
        </div>
        <div className="grid gap-1.5">
          ...
          <FieldHint name="unit" errors={fieldErrors} />
        </div>
        <div className="grid gap-1.5">
        ...
        <div className="grid gap-1.5">
          ...
          <Input
            ...
            disabled={mutation.isPending}
          />
          <FieldHint name="barcode" errors={fieldErrors} />
        </div>
        ...
        <div className="grid gap-2 rounded-md border border-border bg-muted/30 p-3">
          ...
          {Object.entries(fieldErrors).find(([k]) => k === "items" || k.startsWith("items."))?.[1] ? (
              ...
              <div className="grid gap-3">
                ...
                <div className="grid gap-1.5">
                  ...
                  <Input
                    ...
                    disabled={mutation.isPending}
                  />
                  <FieldHint name="weight_kg" errors={fieldErrors} />
                </div>
                <div className="grid gap-1.5">
              ...
              <div className="grid gap-3">
                ...
                <div className="grid gap-1.5">
                  ...
                  <Input
                    ...
                    disabled={mutation.isPending}
                  />
                  <FieldHint name="volume_m3" errors={fieldErrors} />
                </div>
                <div className="grid gap-1.5 sm:grid-cols-2">
                  <div className="grid gap-1.5">
                    <Label>ИКПУ</Label>
