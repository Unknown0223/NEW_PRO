/** Barcha matn/raqam inputlari uchun yagona ko‘rinish (h-9, focus ring). */
...
/** Raqam maydonlari: o‘ngga tekislash + tabular (o‘qish oson). */
export const INPUT_NUMERIC_CLASS = "text-right tabular-nums tracking-tight";
